...
public Action:Menu_CreateWeaponMenu(client, args) {
	...
	AddMenuItem(menu, "ss", "Spawn a pump shotgun");
	AddMenuItem(menu, "sc", "Spawn a chrome shotgun");
	AddMenuItem(menu, "st", "Spawn a tactical shotgun");
	AddMenuItem(menu, "sb", "Spawn a combat shotgun");
	...
	AddMenuItem(menu, "s1", "Spawn an AK47");
	...
	AddMenuItem(menu, "s6", "Spawn an MP5");
	AddMenuItem(menu, "s7", "Spawn an SG552");
	AddMenuItem(menu, "s8", "Spawn a Scout");
	AddMenuItem(menu, "s9", "Spawn a AWP");
	DisplayMenu(menu, client, MENU_DISPLAY_TIME);
	return Plugin_Handled;
}
