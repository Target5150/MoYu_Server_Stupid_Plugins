...
public int Native_GetPermBonus(Handle plugin, int numParams)
{
...
public int Native_GetTempBonus(Handle plugin, int numParams)
{
	new health[HEALTH_TABLE_SIZE] = {0, 0, 0, 0, 0, 0};
	FillHealthTable(health);
...
public int Native_GetMaxPermBonus(Handle plugin, int numParams)
{
	new maxHealth[HEALTH_TABLE_SIZE] = {0, 0, 0, 0, 0, 0};
	FillMaxHealthTable(maxHealth);
	return maxHealth[PERM_HEALTH_INDEX];
}

public int Native_GetMaxTempBonus(Handle plugin, int numParams)
{
	new maxHealth[HEALTH_TABLE_SIZE] = {0, 0, 0, 0, 0, 0};
	FillMaxHealthTable(maxHealth);
	return maxHealth[TEMP_HEALTH_INDEX] + maxHealth[STOCK_TEMP_HEALTH_INDEX];
}
...
public int Native_GetMaxPillsBonus(Handle plugin, int numParams)
{
	new maxHealth[HEALTH_TABLE_SIZE] = {0, 0, 0, 0, 0, 0};
	FillMaxHealthTable(maxHealth);
	return maxHealth[PILLS_HEALTH_INDEX];
}
